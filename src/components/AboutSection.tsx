    ...
    <Section id="about" title="About Me">
      <div className="grid md:grid-cols-5 gap-10 items-center">
        ...
        <div className="md:col-span-3 text-lg text-foreground/80 space-y-4">
          <p>
            Hello! I'm Yuvraj, a passionate front-end developer with a love for creating intuitive and dynamic user interfaces. My journey into web development started with a fascination for how beautiful design and powerful technology can come together to create amazing online experiences.
          </p>
          <p>
